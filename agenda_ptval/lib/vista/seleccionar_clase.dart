...
import 'package:agenda_ptval/controlador/comanda_controller.dart'; // Importar el controlador de comandas
...
class _SeleccionarClasePageState extends State<SeleccionarClasePage> {
  List<Clase> clases = [];
  final _controller = ClaseController();
  final _imagenController = ImagenController();
  final _comandaController = ComandaController();
            ...
            : GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return FutureBuilder<bool>(
                    future: _comandaController.ComprobarComandaClase(clase.nombre),
                    builder: (context, snapshot) {
                      ...
                      if (snapshot.connectionState == ConnectionState.done && snapshot.hasData && snapshot.data == true) {
                        cardColor = const Color.fromARGB(255, 21, 239, 28);
                      }
